...
export const Prescriptions = ( { route, navigation }: searchProp ) => {
                        ...
                        <TouchableOpacity onPress={ () => { } } >
                            <View style={ styles.listItem }>
                                <View style={ { flexDirection: 'column', alignItems: 'flex-start' } }>
                                    <Text style={ {
                                        fontSize: ( 14 / 375 ) * ScreenWidth, color: COLORS.primary, alignSelf: 'center', textAlign: 'left', marginTop: 5
                                    } }>NDC: </Text>
                                ...
                                <View style={ { flexDirection: 'column', alignItems: 'flex-end' } }>
                                    <Text style={ {
                                        fontSize: ( 14 / 375 ) * ScreenWidth, color: COLORS.primary, alignSelf: 'center'
