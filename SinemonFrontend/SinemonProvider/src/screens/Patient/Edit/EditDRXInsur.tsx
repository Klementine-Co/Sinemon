...
const EditDRXInsur = ({drxinsurance, drxinsurances}:editdrxinsuranceProps ) => {
// const EditDRXInsur = ({route, navigation drxinsurancess, drxinsurance} ) => {
      ...
      <>
        {
          ...
          (visible === true) ? ( <EditingDRXInsurances/>): (drxinsurance)
