        ...
        <View style={ { position: 'absolute', right: 0, left: 0, bottom: 0, top: ScreenWidth * .94 } }>
          ...
          <View style={ { right: ScreenWidth * .20 } }>
            ...
            <View style={ { flex: 1, flexDirection: 'column', maxHeight: '50%' } }>
              ...
              <View style={ { flex: 1, marginTop: 35 * ( 1 + Math.floor( ScreenHeight / 800 ) * ( Math.round( ScreenHeight / 800 ) ) ), alignItems: 'flex-start' } }>
            ...
            <View style={ { flex: 1, flexDirection: 'column', maxHeight: '50%', } }>
              ...
              <View style={ { flex: 1, marginTop: 35 * ( 1 + Math.floor( ScreenHeight / 800 ) * ( Math.round( ScreenHeight / 800 ) ) ), alignItems: 'flex-end' } }>
