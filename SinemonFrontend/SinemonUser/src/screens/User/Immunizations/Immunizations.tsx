...
import { getDate } from '../Edit/Forms';

export const Immunizations = ({ route,navigation }: accountProp) => {
                    ...
                    <View style={{flexDirection:'column'}}>
                        ...
                        <View style={styles.listItem}>
                            <View style={{ flexDirection: 'column', alignItems: 'flex-start', width: '30%' }}>
                                <Text style={{fontSize:(14/375)*ScreenWidth, color:COLORS.primary, marginTop: 5, alignItems: 'flex-start' }}>Dr. {item.prov_lastname}, {item.prov_firstname}</Text>
                                <Text style={{fontSize:(14/375)*ScreenWidth, color:COLORS.primary, marginTop: 20, alignItems: 'flex-start' }}>Immunization Date: {getDate(item.vaccination_date)}</Text>
                            </View>
