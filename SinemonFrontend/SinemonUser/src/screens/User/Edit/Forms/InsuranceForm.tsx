...
const medinsurancefields: FieldConfig[] = [
    ...
    { name: 'card', label: 'Card', placeholder: 'Insurance card (eg. PDF)', required: false, type: 'file' },
];
...
export const Insurance: React.FC<CancelProps> = ( { cancel } ) => {
    ...
    return (
        <GenericForm fields={ medinsurancefields } onSubmit={ handleFormSubmit } cancel={ cancel } formName="MedInsurance" />
    );
};
