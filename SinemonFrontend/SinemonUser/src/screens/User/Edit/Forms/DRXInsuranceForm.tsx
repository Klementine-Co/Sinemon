...
const drxfields: FieldConfig[] = [
    ...
    { name: 'contact', label: 'Contact Number', placeholder: 'xxx-xxxx', required: true, type: 'number' },
    { name: 'card', label: 'Card', placeholder: 'Card (eg. PDF)', required: false, type: 'file' },
];
...
export const DRXInsurance: React.FC<CancelProps> = ( { cancel } ) => {
    ...
    return (
        <GenericForm fields={ drxfields } onSubmit={ handleFormSubmit } cancel={ cancel } formName="RXDiscount" />
    );
};
