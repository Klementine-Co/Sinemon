...
import * as FORMS from "./Forms";
  ...
  const EditLabs = ({labs}:editlabsProps) => {
...
function Item( item:labs[0] ) {
    ...
    return (
        ...
        <>
        {
          ...
          (visible === true) ? ( <EditingLabs/>): (<FORMS.Lab cancel={setVisible}/>)
