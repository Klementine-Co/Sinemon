...
const EditMedInsur = ({ medinsurancess}:editmedinsurProps ) => {
  ...
  useEffect(() => {
    ...
    function Item({item}:{item:MedInsurance[0]}) {
      ...
      <>
        {
          ...
          (visible === true) ? ( <EditingMedInsurances/>): (<FORMS.Insurance cancel={setVisible}/>)
