...
TAXONOMY_CODES = (
    ...
    ("207NI0002X", "Dermatology Clinical and Laboratory Dermatological Immunology"),
    ...
    ("207RC0000X", "Internal Medicine Cardiovascular Disease"),
    ("207RI0001X", "Internal Medicine Clinical and Laboratory Immunology"),
    ("207RC0200X", "Internal Medicine Critical Care Medicine"),
    ("207RE0101X", "Internal Medicine Endocrinology Diabetes and Metabolism"),
    ("207RG0100X", "Internal Medicine Gastroenterology"),
    ...
    ("207VH0002X", "Obstetrics and Gynecology Hospice and Palliative Medicine"),
    ("207VM0101X", "Obstetrics and Gynecology Maternal and Fetal Medicine"),
    ("207VX0000X", "Obstetrics and Gynecology Obstetrics"),
    ("207VE0102X", "Obstetrics and Gynecology Reproductive Endocrinology"),
    ...
    ("207VH0002X", "Hospice and Palliative Medicine Obstetrics and Gynecology"),
    ...
    ("207X00000X", "Orthopedic Surgery"),
    ("207XS0114X", "Orthopedic Surgery Adult Reconstructive Orthopedic Surgery"),
    ("207XX0004X", "Orthopedic Surgery Foot and Ankle Surgery"),
    ("207XS0106X", "Orthopedic Surgery Hand Surgery"),
    ("207XS0117X", "Orthopedic Surgery Orthopedic Surgery of the Spine"),
    ...
    ("207RC0001X", "Internal Medicine Clinical Cardiatric Electrophysiology"),
    ("207ZP0101X", "Pathology Anatomic Pathology"),
    ("207ZP0102X", "Pathology Anatomic Pathology and Clinical Pathology"),
    ...
    ("2081S0010X", "Physical Medicine and Rehabilitation Sports Medicine"),
    ...
    ("2081N0008X", "Physical Medicine and Rehabilitation Neuromuscular Medicine"),
    ("2081P2900X", "Physical Medicine and Rehabilitation Pain Medicine"),
    (
        "2081P0010X",
        "Physical Medicine and Rehabilitation Pediatric Rehabilitation Medicine",
    ),
    ("2081P0004X", "Physical Medicine and Rehabilitation Spinal Cord Injury Medicine"),
    ("2081S0010X", "Physical Medicine and Rehabilitation Sports Medicine"),
    ...
    ("207UN0903X", "Nuclear Medicine In Vivo and In Vitro Nuclear Medicine"),
    ...
    ("103TM1800X", "Psychologist Mental Retardation and Developmental Disabilities"),
    ...
    ("225XF0002X", "Occupational Therapist Feeding Eating andSwallowing"),
    ...
    ("133VN1201X", "Dietician Registered Nutrition Obesity and Weight Management"),
    ("133VN1301X", "Dietician Registered Nutrition Oncology"),
    ("133VN1401X", "Dietician Registered Nutrition Pediatric Critical Care"),
    ...
    ("2083P0901X", "Preventive Medicine Public Health and General Preventive Medicine"),
    ("2083S0010X", "Preventive Medicine Sports Medicine"),
    ...
    ("2084B0040X", "Psychiatry and Neurology Behavioral Neurology and Neuropsychiatry"),
    ("2084P0804X", "Psychiatry and Neurology Child and Adolescent Psychiatry"),
    ...
    ("2084H0002X", "Psychiatry and Neurology Hospice and Palliative Medicine"),
    ("2084P0005X", "Psychiatry and Neurology Neurodevelopmental Disabilities"),
    ("2084N0400X", "Psychiatry and Neurology Neurology"),
    (
        "2084N0402X",
        "Psychiatry and Neurology Neurology with Special Qualifications in Child Neurology",
    ...
    ("207RA0002X", "Allopathic and Osteopathic Physicians Internal Medicine"),
    ("100", "General"),
)
